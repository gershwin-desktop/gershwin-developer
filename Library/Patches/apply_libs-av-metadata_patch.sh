...
# Script to apply the libs-av metadata patch (PR #1)
# This patch adds:
#   - Additional AVMetadataCommonKey constants (Composer, Genre, TrackNumber, etc.)
#   - AVMetadataKeySpaceCommon and AVMetadataKeySpaceID3 constants
#   - FFmpeg metadata reading (ID3 tags, album art) in AVURLAsset
#
...
PATCH_FILE="libs-av-metadata.patch"
REPO_DIR="${REPO_DIR:-libs-av}"
...
if grep -q "_commonKeyForFFmpegKey" AVFoundation/AVURLAsset.m 2>/dev/null; then
